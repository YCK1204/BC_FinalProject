...
namespace Destructible2D
{
	...
	public abstract class D2dCollider : MonoBehaviour
	{
		...
		public void SetUsedByEffector(bool value) { usedByEffector = value; }
			...
			/// <summary>This allows you to set the <b>CompositeOperation</b> setting on each generated collider.</summary>
			public Collider2D.CompositeOperation CompositeOperation { set { compositeOperation = value; Refresh(); } get { return compositeOperation; } } [SerializeField] protected Collider2D.CompositeOperation compositeOperation;

			/// <summary>This allows you to set the <b>CompositeOperation</b> value without causing <b>Refresh</b> to be called.</summary>
			public void SetCompositeOperation(Collider2D.CompositeOperation value) { compositeOperation = value; }
		#endif
...
namespace Destructible2D.Inspector
{
	...
	public class D2dCollider_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			#if UNITY_6000_0_OR_NEWER
				Draw("compositeOperation", ref refresh, "This allows you to set the compositeOperation setting on each generated collider.");
			#else
